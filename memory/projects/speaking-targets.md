...
Maintained by Rex (Research Analyst). See `agents/rex.md` — Standing Responsibilities — Speaking Opportunity Research.

**Scope:** Speaking, panel, and moderator opportunities for Tonya matching her expertise lanes — AI adoption + change management, executive communications/thought leadership, translating complex concepts across stakeholder audiences. South Florida/regional and national, next 6–12 months. Panels and moderator roles count, not just keynotes.
...
*Sorted by nearest deadline. "Rolling" = no fixed CFP window; submissions considered on an ongoing basis.*

| Opportunity | Date | Theme / Audience | Deadline | Submission | Pay-to-play? | Pitch Status |
|---|---|---|---|---|---|---|
| **ATD South Florida** (chapter speaker program) | Ongoing — monthly chapter events | Talent development community, South Florida; sessions should map to ATD's Talent Development Capability Model | Rolling — no fixed deadline | ✅ atdsfl.org/Speaker-Proposal | Not indicated either way — not confirmed | 🆕 Draft ready — outbox/speaking-pitch-atd-south-florida.md (2026-08-12) |
| **How to Be Awesome at Your Job** (podcast, host Pete Mockaitis) | Ongoing — episodes release regularly | National audience; content areas: Presence, Productivity, Thinking, Communication, Work Relationships, Career Management — strong overlap with "translating complex concepts across stakeholder audiences" | Rolling — guest pitches accepted anytime | ✅ Guest FAQ: awesomeatyourjob.com/guest-faq/ · Contact: pete@awesomeatyourjob.com | Not pay-to-play (standard guest booking) | 🆕 Draft ready — outbox/speaking-pitch-how-to-be-awesome-at-your-job.md (2026-08-12) |
| **WorkHuman Live Nashville** | April 26–29, 2027 | National HR/workplace-culture conference; past keynotes include Brené Brown, Arianna Huffington | Rolling — online call for speakers open year-round; video sample required | ✅ workhuman.com/events/become-a-speaker/ | Not indicated either way — not confirmed | 🆕 Draft ready, but blocked on a video sample the form requires — outbox/speaking-pitch-workhuman-live.md (2026-08-12) |
...
## Recently Closed (missed — for reference, not action)

| Opportunity | Date | Deadline | Status |
|---|---|---|---|
| **ATD International Conference & Expo 2027** | Boston, May 16–19, 2027 | Proposals due **August 6, 2026** (confirmed via ATD's own RFP FAQ) | ❌ Closed 6 days before this refresh. Next window: ATD 2028 CFP, typically opens mid-year the year prior (~summer 2027) |
| **HR Florida Conference & Expo** (SHRM Florida) | Kissimmee, FL — Aug 30–Sept 2, 2026 | Speaker proposal deadline **July 31, 2026, 5:00pm ET** (shrmflorida.org) — note: could not fully confirm this deadline applies to the 2026 edition specifically vs. a general recurring page, but the event itself is only 18 days out as of this refresh, so treat as closed either way | ❌ Closed. Watch for HR Florida 2027 CFP to open, typically announced in the months after the current year's event wraps |

## Already Passed (historical — watch for next edition's announcement)
